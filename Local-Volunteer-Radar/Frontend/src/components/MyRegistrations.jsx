...
const MyRegistrations = () => {
    ...
    return (
        <>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
                    {['All', 'Pending', 'Approved', 'Rejected'].map((filterOption) => (
                        <button
                            ...
                            onMouseOver={(e) => { if (filter !== filterOption) e.currentTarget.style.background = '#f9fafb'; }}
                            onMouseOut={(e) => { if (filter !== filterOption) e.currentTarget.style.background = 'white'; }}
                        >
            ...
            {/* Map Modal — single instance shared across all cards */}
            <MapModal
                isOpen={!!mapLocation}
