const LogoutPopup = ({
    ...
    return (
        <div
            className={`fixed top-6 right-6 bg-white rounded-lg shadow-2xl p-4 flex items-center gap-3 border-l-4 ${borderColor} transform transition-all duration-500 z-50 ${
